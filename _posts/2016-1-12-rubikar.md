...
**Update 1** : To my understanding, the awe.js seems to be dead and currently is not under active development. So I'll be doing a new tutorial on the rubik's cube creation and game design using a more actively developed library. So please stay tuned and thank you.  
