...
**Update 1** : Reveal-chart has been deprecated, please use the chart module in revealjs-plugin. link : [https://github.com/rajgoel/reveal.js-plugins](https://github.com/rajgoel/reveal.js-plugins)
