    ...
    if (! (e[t] && e[t].version > s)) {
        ...
        e[t].prototype = {
            ...
            _initAddons: function() {
                for (var n in e[t].addons) e[t].addons[n].add.call(this),
        ...
        setup: function() {
            if (this.opts.offCanvas) {
                ...
                if (this.conf[s], h = t[e].glbl, "boolean" == typeof o && o && (o = {
                    height: "auto"
                }), "object" != typeof o && (o = {}), o = this.opts[s] = t.extend(!0, {},
                t[e].defaults[s], o), "auto" == o.height) {
...
function(i) {
    ...
    i[e].addons[s] = {
        setup: function() {
            ...
            i[e].defaults[s], a), this.bind("init", function() {
    ...
    e[n].addons[i] = {
        setup: function() {
            ...
            if (this.conf[i], d = e[n].glbl, "boolean" == typeof l && (l = {
                ...
                add: !0,
                visible: l
            }), "object" != typeof l && (l = {}), l = this.opts[i] = e.extend(!0, {},
            e[n].defaults[i], l), l.visible++, l.add) {
